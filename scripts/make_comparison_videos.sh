#!/bin/bash
# Combine matching renders from 4 model directories side-by-side with labels.
...
DIR_FCS1_BILAT2="renders/fcs1_com_bilat2"
OUT_DIR="renders/comparison"

mkdir -p "$OUT_DIR"

# Iterate over the baseline videos and look for matching files in the other dirs
