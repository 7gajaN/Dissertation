...
def parse_train_opt():
    ...
    parser.add_argument(
        ...
        help="Weight for CoM/BoS balance loss (0.0 = disabled)"
    )
    parser.add_argument(
        "--bilateral_loss_weight", type=float, default=0.0,
        help="Weight for bilateral foot exclusivity loss (0.0 = disabled)"
    )
    parser.add_argument(
        "--foot_height_loss_weight", type=float, default=0.0,
        help="Weight for foot height during contact loss (0.0 = disabled)"
    )
